            ...
            <nav class="site-navigation position-relative text-right text-lg-center" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                ...
                <li class="has-children active">
                  <a href="engineering.php">Gallery</a>
                  <ul class="dropdown">
    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-md-7">
          <div class="row mb-5">
            <div class="col-12 ">
              <h2 class="site-section-heading text-center">Engineering ki Yaade</h2>
            </div>
          </div>
        </div>
      ...
      <div class="row" id="lightgallery">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2 item" data-aos="fade" data-src="images/engg/img1 (105).jpg" data-sub-html="<h4>Fading Light</h4><p>..</p>">
